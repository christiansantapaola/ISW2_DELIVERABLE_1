package it.uniroma2.dicii.santapaola.christian.git;
...
/**
 * it.uniroma2.dicii.santapaola.christian.GitSubSystem.GitHandler is a class which handle all the git subsystem.
...
public class GitHandler {
    ...
    /**
     * Constructor of it.uniroma2.dicii.santapaola.christian.GitSubSystem.GitHandler instance from local git repository.
    ...
    /**
     * Constructor of it.uniroma2.dicii.santapaola.christian.GitSubSystem.GitHandler instance from a remote git repository.
     * @param url, url of the remote repository.
     * @param newLocalRepository, File object pointing to where to clone the remote repository.
     * @throws IOException
     * @throws GitAPIException
     */
    public GitHandler(String url, File newLocalRepository) throws GitAPIException{
